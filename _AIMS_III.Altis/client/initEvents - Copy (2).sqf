...
player addEventHandler ["GetInMan", { params ["_unit", "_role", "_vehicle", "_turret"]; if (_vehicle isKindOf "AIR") then { setViewDistance 2000; setObjectViewDistance [2000,200]; setTerrainGrid 12.5; } else { setViewDistance 1500; setObjectViewDistance [1500,200]; setTerrainGrid 12.5; }; } ];

player addEventHandler ["GetOutMan", { params ["_unit", "_role", "_vehicle", "_turret"]; setViewDistance 1000; setObjectViewDistance [1000,200]; setTerrainGrid 12.5; } ];

player addEventHandler ["SeatSwitchedMan", { params ["_unit1", "_unit2", "_vehicle"]; if (assignedVehicleRole _unit1 find "Turret" > -1) then { setViewDistance 1500; setObjectViewDistance [1500,200]; setTerrainGrid 12.5; }; } ];
